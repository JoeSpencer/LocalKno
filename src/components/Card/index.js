...
class Card extends Component {
    ...
    <div className='bg-white border rounded-lg overflow-hidden max-w-sm'>
        ...
        <div className='p-6 text-gray-900'>
            ...
            <div className='px-0 py-4 h-4 overflow-x-scroll inline'>
                <span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2'>Some Trails Open</span>
                <span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2'>A Skis</span>
                <span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700'>Maple Grove</span>
                <span className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700'>Maple Grove</span>
